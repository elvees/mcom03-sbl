...
#define TOP_LSP0_SUBS_SYS_SECURE_POS     BIT(5)
#define TOP_LSP1_SUBS_SYS_SECURE_POS     BIT(6)
...
#define TOP_HSP_SUBS_SYS_TRUSTED_POS             BIT(3)
#define TOP_LSP0_SUBS_SYS_TRUSTED_POS            BIT(4)
#define TOP_LSP1_SUBS_SYS_TRUSTED_POS            BIT(5)
