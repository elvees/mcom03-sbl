...
#define IOMMU_PASSTHROUGH_TLB_WRITE_CHANNEL    0
#define IOMMU_PASSTHROUGH_TLB_READ_CHANNEL     1
#define IOMMU_PASSTHROUGH_TLB_EXEC_CHANNEL     2
#define IOMMU_XPCT_RETRY_TLB_WRITE_CHANNEL     3
#define IOMMU_XPCT_RETRY_TLB_READ_CHANNEL      4
#define IOMMU_XPCT_DUMMY_TLB_WRITE_CHANNEL     5
#define IOMMU_XPCT_DUMMY_TLB_READ_CHANNEL      6
#define IOMMU_XPCT_AUTODUMMY_TLB_WRITE_CHANNEL 7
#define IOMMU_XPCT_AUTODUMMY_TLB_READ_CHANNEL  8
...
void iommu_reset(iommu_regs_t *dev)
{
	...
	// Disable skipping translation for all channel TLB
	for (int i = 0; i < IOMMU_TLB_MAX_NUM; i++)
		dev->tlb_ctrl[i] = BIT(IOMMU_PASSTHROUGH_TLB_WRITE_CHANNEL) |
		                   BIT(IOMMU_PASSTHROUGH_TLB_READ_CHANNEL) |
		                   BIT(IOMMU_PASSTHROUGH_TLB_EXEC_CHANNEL);
