...
macro(build_static_library LIBRARIES_LIST LIBRARY_NAME)
    foreach(LIBRARY IN LISTS ${LIBRARIES_LIST})
        add_subdirectory(${LIBRARY})
    endforeach()

    add_library(${LIBRARY_NAME} STATIC)
    foreach(LIBRARY IN LISTS ${LIBRARIES_LIST})
        target_sources(${LIBRARY_NAME} PRIVATE $<TARGET_OBJECTS:${LIBRARY}>)
    endforeach()
endmacro()
